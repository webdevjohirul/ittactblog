        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img style="border-radius: 50%;" src="../upload/amin.jpg" alt="" height="200" width="230">
                    <span class="font-weight-bold h3 mt-2"><?php echo $admin['admin_name']; ?></span>
                    <span class="text-black-50"><?php echo $admin['admin_email']; ?></span>
                    <span class="text-info">Full Stack Web Developer</span>
                </div>
            </div>
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input name="first_name" type="text" class="form-control" placeholder="enter first name" value="">
                        </div>
                        <div class="col-md-6">
                            <label class="labels">Last Name</label>
                            <input name="last_name" type="text" class="form-control" placeholder="enter last name" value="">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input name="email" type="email" class="form-control" placeholder="" value="<?php echo $admin['admin_email']; ?>">
                        </div>
                        <div class="col-md-12">
